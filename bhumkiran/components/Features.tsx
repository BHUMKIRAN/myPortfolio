...
const subtitle = "I am a passionate developer specializing in creating exceptional digital experiences. I bring ideas to life through clean code and innovative solutions.";
    ...
    return (
        <>
            {featuresData.map((feature, index) => (
                <div
                    key={index}
                    /* Applying the Neumorphic Card Style */
                    className="group p-8 transition-all duration-300 ease-in-out text-left"
                    style={{
                        background: 'var(--bg)',
                ...
                >
                    <div 
                        className="mb-6 inline-block p-3 rounded-lg transition-colors duration-300 group-hover:text-white"
                    ...
                    <div className="mt-6 w-10 h-1 bg-transparent group-hover:bg-[var(--primary)] transition-all duration-300 rounded-full" />
                </div>
            ))}
        </>
    );
